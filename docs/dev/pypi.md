...
write_to = "earth_embeddings/_version.py"
```
...
```toml
[project]
name = "earth_embeddings"
description = "Tools for fetching and wrangling with AlphaEarth embeddings"
authors = [{"name" = "Ulas Karaoz"}]
...
ls dist/
# earth_embeddings-1.2.3.tar.gz
# earth_embeddings-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/earth_embeddings-*.whl

# Verify installation
python -c "import earth_embeddings; print(earth_embeddings.__version__)"
...
3. Fill in the form:
   - **PyPI Project Name**: `earth_embeddings`
...
1. Go to your project page: `https://pypi.org/project/earth_embeddings/`
...
```bash
# View on PyPI
open https://pypi.org/project/earth_embeddings/

# Install from PyPI
pip install earth_embeddings
...
ls earth_embeddings/_version.py
```
