...
- Installed with `pip install earth_embeddings`
...
- Installed with `pip install earth_embeddings[dev]`
...
# Or from PyPI
uv pip install earth_embeddings
...
# Creates:
# dist/earth_embeddings-X.Y.Z.tar.gz (source)
# dist/earth_embeddings-X.Y.Z-py3-none-any.whl (wheel)
```
