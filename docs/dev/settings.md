...
- **`earth_embeddings/conf/settings.py`**: Main Settings class
- **`earth_embeddings/settings.py`**: Global settings instance
...
```python
from earth_embeddings.conf import settings
...
```python
# earth_embeddings/conf/settings.py
...
from earth_embeddings.conf.settings import Settings
...
```python
from earth_embeddings.conf.cache import CacheSettings
